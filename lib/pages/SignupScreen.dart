...
import 'PreFormationScreen.dart';
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: AppColors.textColor.withOpacity(0.3), width: 1.4),
          ),
        ),
        ...
        Expanded(
          child: RichText(
            text: const TextSpan(
              ...
              children: [
                TextSpan(
                    text: 'Je confirme avoir lu, consenti et accepté '),
                TextSpan(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => const PreFormationScreen(),
                ),
              );
            },
            child: const Text(
